...
// Target configurations - UPDATED: paths now point to country_visualization folder
const targets = {
    any: {
        name: 'Any Complications',
        file: 'country_visualization/any.csv'
    },
    chole: {
        name: 'Cholecystectomy Complications',
        file: 'country_visualization/chole.csv'
    },
    major: {
        name: 'Major Complications',
        file: 'country_visualization/major.csv'
    }
};
    ...
    try {
        ...
        errorDiv.innerHTML = `
            ...
            <ul style="text-align: left; max-width: 500px; margin: 20px auto;">
                <li>Make sure the country_visualization folder is in the same directory as index.html</li>
...
async function loadWorldMap(data) {
    ...
    try {
        // Load world map data from local file - UPDATED: path now points to country_visualization folder
        console.log('Loading world map data from local file...');
        const world = await d3.json('country_visualization/countries-110m.json');
        ...
        mapContainer.innerHTML = `
            <div class="no-data">
                ...
                <p><strong>Possible solutions:</strong></p>
                <ul style="text-align: left; max-width: 500px; margin: 20px auto;">
                    <li>Make sure 'countries-110m.json' is in the country_visualization folder</li>
...
// Download current data as CSV - UPDATED: paths now point to country_visualization folder
function downloadCurrentData() {
    ...
    const filenameMap = {
        'any': 'country_visualization/any.csv',
        'chole': 'country_visualization/chole.csv',
        'major': 'country_visualization/major.csv'
    };
    ...
    link.href = filename;
    link.download = filename.split('/').pop(); // Use just the filename for download
